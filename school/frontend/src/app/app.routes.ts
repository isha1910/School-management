...
export const routes: Routes = [
  ...
  children: [
...

    {
      path: 'my-classes',
      loadComponent: () =>
        import('./pages/teacher/my-classes/teacher-my-classes.component')
          .then(m => m.TeacherMyClassesComponent),
    },

    {
      path: 'classes/:classId/students',
      loadComponent: () =>
        import('./pages/teacher/class-students/teacher-class-students.component')
          .then(m => m.TeacherClassStudentsComponent),
    },
  ],
},
  // ─── STUDENT ROUTES ───
